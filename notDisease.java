...
//
/*
 * it will make 3D.txt as output file
 *ASUMPTION
...
public class notDisease {
	...
	try
	{
		out = new FileOutputStream("3D.txt");
		p = new PrintStream( out );
		p.println ("***************3D structure *******************");
	}
	catch (Exception e)
	{
	...
	String to_match2 = "DR   PDB";//(b) DR   PDB (DR<3 spaces>PDB)
	...
	catch (Exception e)
	{
		...
		System.out.println("total of "+counter+"number of proteins have known 3d structures");
  }
